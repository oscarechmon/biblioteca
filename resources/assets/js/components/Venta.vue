                        ...
                        <div class="form-group row border">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <v-select
                                        :on-search="selectTienda"
                                        label="nombre"
                                        :options="arrayTienda"
                                        placeholder="Buscar Tienda..."
                                        :onChange="getDatosTienda"                                        
                                    >
                                    </v-select>
                                </div>
                            </div>
...
<script>
    ...
    export default {
        ...
        methods : {
            ...
            selectTienda(search,loading){
                let me=this;
                loading(true)

                var url= '/tienda/selectTienda?filtro='+search;
                axios.get(url).then(function (response) {
                    let respuesta = response.data;
                    q: search
            ...
            validarVenta(){
                ...
                if (me.idtienda==0) me.errorMostrarMsjVenta.push("Seleccione un distribuidor o tienda");
            ...
            verVenta(id){
                ...
                axios.get(url).then(function (response) {
                    ...
                    me.tienda= arrayTiendaT[0]['tienda'];
